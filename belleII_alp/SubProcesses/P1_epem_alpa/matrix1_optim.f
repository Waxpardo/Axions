...
C     
C     Process: e+ e- > alp a WEIGHTED<=8 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WZ) 
        ...
        IF(mdl_Walp.ne.0d0) then 
          fk_mdl_Walp = SIGN(MAX(ABS(mdl_Walp), ABS(mdl_Malp
     $     *small_width_treatment)), mdl_Walp) 
        else 
          fk_mdl_Walp = 0d0
        endif
      ...
      AMP(:,:) = (0d0,0d0)
            CALL OXXXXX(P(0,1),MDL_ME,+1,-1*IC(1),W(1,1))  !  count 4
      CALL OXXXXX(P(0,1),MDL_ME,-1,-1*IC(1),W(1,2))  !  count 4
      CALL IXXXXX(P(0,2),MDL_ME,+1,+1*IC(2),W(1,3))  !  count 4
      CALL IXXXXX(P(0,2),MDL_ME,-1,+1*IC(2),W(1,4))  !  count 4
      CALL SXXXXX(P(0,3),+1*IC(3),W(1,5))  !  count 16
      CALL VXXXXX(P(0,4),ZERO,+1,+1*IC(4),W(1,6))  !  count 8
      CALL VXXXXX(P(0,4),ZERO,-1,+1*IC(4),W(1,7))  !  count 8
      CALL FFV1P0_3(W(1,3),W(1,1),GC_4,ZERO,FK_ZERO,W(1,8))  !  count 2
      CALL FFV1P0_3(W(1,3),W(1,2),GC_4,ZERO,FK_ZERO,W(1,9))  !  count 2
      CALL FFV1P0_3(W(1,4),W(1,1),GC_4,ZERO,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1P0_3(W(1,4),W(1,2),GC_4,ZERO,FK_ZERO,W(1,11))  !  count 2
      CALL VVS2P1N_2(W(1,6), W(1,5), GC_17, TMP(1))
      call CombineAmp(4,
     & (/6,2,8,4/), 
     & (/8,9,10,11/),
     & TMP, W, AMP(1,1))
      CALL VVS2P1N_2(W(1,7), W(1,5), GC_17, TMP(1))
      call CombineAmp(4,
     & (/5,1,7,3/), 
     & (/8,9,10,11/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3_3(W(1,3),W(1,1),GC_43,GC_40,MDL_MZ,FK_MDL_WZ,W(1,12))  !  count 2
      CALL FFV2_3_3(W(1,3),W(1,2),GC_43,GC_40,MDL_MZ,FK_MDL_WZ,W(1,13))  !  count 2
      CALL FFV2_3_3(W(1,4),W(1,1),GC_43,GC_40,MDL_MZ,FK_MDL_WZ,W(1,14))  !  count 2
      CALL FFV2_3_3(W(1,4),W(1,2),GC_43,GC_40,MDL_MZ,FK_MDL_WZ,W(1,15))  !  count 2
      CALL VVS2P1N_2(W(1,6), W(1,5), GC_45, TMP(1))
      call CombineAmp(4,
     & (/6,2,8,4/), 
     & (/12,13,14,15/),
     & TMP, W, AMP(1,2))
      CALL VVS2P1N_2(W(1,7), W(1,5), GC_45, TMP(1))
      call CombineAmp(4,
     & (/5,1,7,3/), 
     & (/12,13,14,15/),

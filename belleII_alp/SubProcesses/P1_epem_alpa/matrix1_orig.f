...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WALP)
      ...
      CALL FFV1P0_3(W(1,2),W(1,1),GC_4,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS2_0(W(1,4),W(1,5),W(1,3),GC_17,AMP(1))
      CALL FFV2_3_3(W(1,2),W(1,1),GC_43,GC_40,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVS2_0(W(1,4),W(1,5),W(1,3),GC_45,AMP(2))

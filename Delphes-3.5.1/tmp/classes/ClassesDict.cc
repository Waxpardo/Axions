...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Tower*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Tower", ::Tower::Class_Version(), "classes/DelphesClasses.h", 514,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::HectorHit*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("HectorHit", ::HectorHit::Class_Version(), "classes/DelphesClasses.h", 646,
...
namespace ROOT {
   static void *new_CscCluster(void *p = nullptr);
   ...
   {
      ::CscCluster *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::CscCluster >(nullptr);
      static ::ROOT::TGenericClassInfo 
         instance("CscCluster", ::CscCluster::Class_Version(), "classes/DelphesClasses.h", 669,
   ...
   {
      return GenerateInitInstanceLocal(static_cast<::CscCluster*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::CscCluster*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Candidate*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Candidate", ::Candidate::Class_Version(), "classes/DelphesClasses.h", 698,
...
//______________________________________________________________________________
atomic_TClass_ptr CscCluster::fgIsA(nullptr);  // static to hold class pointer
...
{
   return ::ROOT::GenerateInitInstanceLocal((const ::CscCluster*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int CscCluster::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::CscCluster*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *CscCluster::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CscCluster*)nullptr)->GetClass();
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CscCluster*)nullptr)->GetClass(); }
   return fgIsA;
}
...
namespace ROOT {
   ...
   // Wrapper around operator delete
   static void delete_CscCluster(void *p) {
      delete (static_cast<::CscCluster*>(p));
   }
   static void deleteArray_CscCluster(void *p) {
      delete [] (static_cast<::CscCluster*>(p));
   }

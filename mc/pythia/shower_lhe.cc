// shower_lhe.cc -- standalone Pythia8 parton-shower driver for the Axions
// validation pipeline (Stage 2).
//
// This is a VERBATIM copy of the PYTHIA 8.310 example main44.cc (LHE -> HepMC2),
// vendored into the repository because MadGraph in the LCG_105 build is packaged
// without the MG5aMC_PY8_interface and cannot drive Pythia itself (see
// mc/cards/validation_mumu/README.md for the full diagnosis). Running Pythia
// standalone needs no network and reproduces identically on Condor workers.
//
// Usage:  shower_lhe <pythia .cmnd settings file> <output .hepmc file>
//   arg 1: Pythia command file (sets Beams:LHEF = input LHE, shower options, ...)
//   arg 2: output file for HepMC2 events (fed to DelphesHepMC2 in Stage 3)
//
// ----------------------------------------------------------------------------

...
set ExecutionPath {
  ...
  TrackSmearing
  ClusterCounting
  # TimeSmearing/TimeOfFlight are intentionally skipped in this project copy.
  # The LCG Delphes build used on Nikhef expects a missing MuonMomentumSmearing
  # input for TimeSmearing. Photon-only ALP studies do not use track timing.
  TrackMerger
  Calorimeter
  EFlowMerger
...
# add InputArray InputArray
  # Directly merge cluster-counted tracks; see ExecutionPath timing note above.

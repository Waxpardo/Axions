####################################################################
# FCC-ee IDEA detector model — mu+mu- VALIDATION MINIMAL CARD
#
# Base card: delphes_card_IDEA.tcl
...
#
# *** SOFTWARE-CHAIN VALIDATION CARD -- NOT a validated FCC-ee physics result ***
#
# Modifications vs card_IDEA_winter2023.tcl (each marked "MUMU:" below):
#   - NeutrinoFilter, GenJetFinder, GenMissingET, FastJetFinder, JetEnergyScale,
#     JetFlavorAssociation, BTagging, TauTagging removed from ExecutionPath.
#   - Corresponding GenJet, GenMissingET, Jet branches removed from TreeWriter.
#
# Reason: e+e- -> mu+mu- has no hadronic final state. With zero input particles
# the Durham kt jet finder (JetAlgorithm 10) throws a fastjet::Error which causes
# a segfault identical to the one we already fixed for the Belle II card. All
# module *definitions* are kept below (inert unless added to ExecutionPath).
####################################################################
...
# MUMU: NeutrinoFilter, GenJetFinder, GenMissingET, FastJetFinder,
#        JetEnergyScale, JetFlavorAssociation, BTagging, TauTagging
#        intentionally omitted from ExecutionPath — no hadronic final state.
#        Module definitions below are retained but inert.
...
########################################
# Smearing for charged tracks (IDEA drift chamber model)
########################################
...
# MUMU: NeutrinoFilter, GenJetFinder, GenMissingET, FastJetFinder,
#        JetEnergyScale, JetFlavorAssociation, BTagging, TauTagging
#        definitions omitted — modules are inactive without ExecutionPath entry.
...
module TreeWriter TreeWriter {
    ...
    # MUMU: GenJetFinder/jets, GenMissingET/momentum, JetEnergyScale/jets removed.

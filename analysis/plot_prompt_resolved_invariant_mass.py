...
by the pipeline and overlays an arbitrary ALP signal hypothesis.  It is meant
as a pedagogical paper/report figure: the black points are pseudo-data, not
real data, and the red curves are the expected background and signal-plus-
